  ...
  return (
    <div style={{ width: '100%', height: '100%', background: '#FAFAF9', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2 }}>
      ...
      <svg width="44" height="20" viewBox="0 0 1280 560" preserveAspectRatio="xMidYMid meet" style={{ marginTop: 4 }}>
        <polyline points={ROUTE_POINTS} stroke="#4F46E5" strokeWidth="22" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  );
}
function ThumbB() {
  return (
    <div style={{ width: '100%', height: '100%', background: 'linear-gradient(180deg, #1E1B4B 0%, #2A2566 100%)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 2, position: 'relative' }}>
      <svg width="50" height="22" viewBox="0 0 1280 560" preserveAspectRatio="xMidYMid meet" style={{ position: 'absolute', top: 28, opacity: 0.85 }}>
        <polyline points={ROUTE_POINTS} stroke="#A5B4FC" strokeWidth="36" fill="none" strokeLinecap="round" strokeLinejoin="round" opacity="0.5" />
        <polyline points={ROUTE_POINTS} stroke="#fff" strokeWidth="10" fill="none" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ...
    <div style={{
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'flex-start', gap: 6 }}>
        ...
        <div style={{ width: '100%', marginTop: 24 }}>
          <svg width="100%" height="160" viewBox="0 0 1280 560" preserveAspectRatio="xMidYMid meet">
            <polyline points={ROUTE_POINTS} stroke="#4F46E5" strokeWidth="8" fill="none" strokeLinecap="round" strokeLinejoin="round" />
            <circle cx={ROUTE_START.x} cy={ROUTE_START.y} r="18" fill="#fff" stroke="#4F46E5" strokeWidth="5" />
            <circle cx={ROUTE_FINISH.x} cy={ROUTE_FINISH.y} r="14" fill="#F97066" />
          </svg>
        </div>
      </div>
    ...
    <div style={{
      ...
      <div style={{ position: 'absolute', top: 78, left: 0, right: 0, height: 380 }}>
        <svg viewBox="0 0 1280 560" preserveAspectRatio="xMidYMid slice" width="100%" height="100%">
          <defs>
            <filter id="bGlowBig" x="-30%" y="-30%" width="160%" height="160%">
              <feGaussianBlur stdDeviation="22" />
            </filter>
            <filter id="bGlowMid" x="-30%" y="-30%" width="160%" height="160%">
              <feGaussianBlur stdDeviation="12" />
            </filter>
            <filter id="bGlowTight" x="-30%" y="-30%" width="160%" height="160%">
          ...
          {/* 4-layer glow stack */}
          <polyline points={ROUTE_POINTS} stroke="#4F46E5" strokeWidth="44" fill="none" opacity="0.40" filter="url(#bGlowBig)" strokeLinejoin="round" strokeLinecap="round" />
          <polyline points={ROUTE_POINTS} stroke="#818CF8" strokeWidth="28" fill="none" opacity="0.50" filter="url(#bGlowMid)" strokeLinejoin="round" strokeLinecap="round" />
          <polyline points={ROUTE_POINTS} stroke="#A5B4FC" strokeWidth="14" fill="none" opacity="0.65" filter="url(#bGlowTight)" strokeLinejoin="round" strokeLinecap="round" />
          <polyline points={ROUTE_POINTS} stroke="#fff" strokeWidth="4" fill="none" strokeLinecap="round" strokeLinejoin="round" />
          {/* Start / finish */}
          <circle cx={ROUTE_START.x} cy={ROUTE_START.y} r="11" fill="#fff" />
          <circle cx={ROUTE_FINISH.x} cy={ROUTE_FINISH.y} r="11" fill="#F97066" />
        </svg>
      </div>
