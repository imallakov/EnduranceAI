...
function App() {
  return (
    <DesignCanvas>
      <DCSection id="plan" title="Training Plan · Phase 7 — the page people screenshot">
        <DCArtboard id="plan-full" label="Full /plans · active · 1440 × 1820" width={1440} height={1820}>
          <PlanPage />
        </DCArtboard>
        <DCArtboard id="plan-empty" label="Empty state · no plan yet · 1440 × 920" width={1440} height={920}>
          <EmptyPlanState />
        </DCArtboard>
        <DCArtboard id="plan-drawer" label="Workout drawer open · 1440 × 920" width={1440} height={920}>
          <PlanPageWithDrawer />
        </DCArtboard>
        <DCArtboard id="plan-generate" label="Generate plan modal · 1440 × 920" width={1440} height={920}>
          <PlanPageWithGenerate />
        </DCArtboard>
        <DCArtboard id="plan-strip-detail" label="Phase strip detail · 2× · 1200 × 540" width={1200} height={540}>
          <PhaseStripDetail />
        </DCArtboard>
        <DCArtboard id="plan-week-detail" label="Current week grid detail · 1200 × 420" width={1200} height={420}>
          <CurrentWeekDetail />
        </DCArtboard>
        <DCArtboard id="plan-cells" label="Workout cell · 7 variants · 1200 × 480" width={1200} height={480}>
          <WorkoutCellVariants />
        </DCArtboard>
        <DCArtboard id="plan-export" label="Export menu · 1440 × 720" width={1440} height={720}>
          <PlanPageWithExport />
        </DCArtboard>
        <DCArtboard id="plan-weeks-list" label="All-weeks list component · 460 × 920" width={460} height={920}>
          <AllWeeksListDetail />
        </DCArtboard>
        <DCArtboard id="plan-volume" label="Weekly volume chart · 460 × 340" width={460} height={340}>
          <VolumeChartDetail />
        </DCArtboard>
        <DCArtboard id="plan-export-menu" label="Export menu detail · 460 × 360" width={460} height={360}>
          <ExportMenuDetail />
        </DCArtboard>
      </DCSection>
